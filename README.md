...
Examples:
    ...
    rage --decrypt hello.age
    rage --decrypt hello.age.asc

Problems:

  * Reference age binary (not rage) has weird characters in place of terminal escape sequences on Windows Console - https://github.com/FiloSottile/age/issues/474
  * pyage notes
