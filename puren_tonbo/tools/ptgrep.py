...
if colorama:
    ...
    #color_filename = colorama.Fore.YELLOW + colorama.Back.BLACK  # Windows (campbell) default Blue is hard to read with Windows 11 on Black, also see color_filename_zebra - https://github.com/clach04/puren_tonbo/issues/177
    ...
    #color_filename_zebra = colorama.Fore.BLACK + colorama.Back.YELLOW  # TODO specify fg - TODO allow control and override of this - https://github.com/clach04/puren_tonbo/issues/177
    ...
    if guess_color_available:
        ...
        #color_filename_zebra = color_filename + '\x1b[47m'  # TODO allow control and override of this
        color_filename_zebra = '\x1b[44m'  # TODO specify fg - # TODO allow control and override of this
